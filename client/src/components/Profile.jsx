...
const Profile = () => {
  ...
  return (
    <div >
        <div className="d-flex justify-content-center align-items-center text-center vh-100" style= {{backgroundImage : "linear-gradient(#90EE90,#90EE90,rgba(93,0,255,.555))"}}>
